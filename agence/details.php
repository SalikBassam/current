...
<div id="announce_header_p">
  <?php
  include("connect.php");
  $sql = "SELECT announce.titre,announce.description,announce.prix, announce.date_publication,announce.categorie,announce.Type ,announce.code_postal, announce.Ville, client.nom,client.prenom,client.telephone FROM `announce` JOIN client ON announce.numero_client=client.numero_client WHERE numero_annouce=:numero_annouce";
...
<?php
      include("connect.php");
      $sql1= "SELECT announce.numero_annouce,announce.code_postal, announce.titre, announce.prix, announce.categorie, announce.Type,announce.Ville,images.image FROM announce JOIN images on announce.numero_annouce=images.numero_annouce
