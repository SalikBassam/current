...
$sql = "SELECT announce.numero_annouce,announce.code_postal,announce.date_publication, announce.titre, announce.prix, announce.categorie, announce.Type,announce.Ville,images.image FROM announce JOIN images on announce.numero_annouce=images.numero_annouce
 WHERE 1=1";
if (!empty($type)) {
